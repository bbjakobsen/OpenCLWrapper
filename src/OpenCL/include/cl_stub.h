...
#define  LOGD(...)  __android_log_print(ANDROID_LOG_DEBUG, "cl_stub", __VA_ARGS__)
...
typedef cl_int (*f_clSetKernelArgSVMPointer)(cl_kernel    kernel,
                         cl_uint      arg_index,
...
typedef cl_int
(*f_clEnqueueSVMFree)(cl_command_queue  command_queue,
...
typedef cl_int
(*f_clEnqueueSVMMemcpy)(cl_command_queue  command_queue,
...
typedef cl_int
(*f_clEnqueueSVMMemFill)(cl_command_queue  command_queue,
                    void *            svm_ptr,
                    const void *      pattern,
                    size_t            pattern_size,
                    size_t            size,
...
typedef cl_int
(*f_clEnqueueSVMMap)(cl_command_queue  command_queue,
...
typedef cl_int
(*f_clEnqueueSVMUnmap)(cl_command_queue  command_queue,
                  void *            svm_ptr,
                  cl_uint           num_events_in_wait_list,
                  const cl_event *  event_wait_list,
                  cl_event *        event) CL_API_SUFFIX__VERSION_2_0;
